...
public class NotificationServiceImpl implements NotificationService {
    ...
    public void markAsRead(Long notificationId, Long userId) {
        ...
        notificationRepository.save(notification);
        logService.log(com.inspector.platform.entity.ActionType.UPDATE, "Notification", notificationId.toString(), "Marked notification as read");
    }
    ...
    public void markAllAsRead(Long userId) {
        ...
        logService.log(com.inspector.platform.entity.ActionType.UPDATE, "Notification", "ALL", "Marked all notifications as read");
    }
    ...
    public void updatePushToken(Long userId, String token) {
        ...
        logService.log(com.inspector.platform.entity.ActionType.UPDATE, "User", userId.toString(), "Updated push token");
