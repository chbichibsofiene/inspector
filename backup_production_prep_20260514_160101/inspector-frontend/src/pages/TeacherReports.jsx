  ...
  return (
    <div className="layout-container">
      <header className="page-header">
        <div>
          <h1 className="page-title">{t('myPedagogicalReports')}</h1>
          <p className="page-subtitle">{t('viewDownloadReports')}</p>
        </div>
      ...
      <div className="dashboard-content">
        ...
        {loading ? (
          ...
          <div className="empty-state-card">
            ...
            <p>{searchTerm ? t('noReportsMatch') : t('noFinalizedReports')}</p>
          </div>
        ) : (
                ...
                <div className="card-body">
                  ...
                  <div className="report-detail-group">
                    <div className="detail-row">
                      <Calendar size={14} />
                      <span>{new Date(report.updatedAt).toLocaleDateString(i18n.language, { dateStyle: 'long' })}</span>
                    </div>
                    <div className="detail-row">
                      <User size={14} />
        ...
        <div className="modal-overlay" onClick={() => setSelectedReport(null)}>
          <div className="report-detail-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-meta-grid">
              <div className="meta-item"><Calendar size={14} /><span>{new Date(selectedReport.updatedAt).toLocaleDateString(i18n.language, { dateStyle: 'long' })}</span></div>
            ...
            {selectedReport.observations && (
              <div className="modal-section">
                <div className="modal-section-label"><MessageSquare size={14} /> {t('observations')}</div>
            ...
            {selectedReport.recommendations && (
              <div className="modal-section">
                <div className="modal-section-label"><Lightbulb size={14} /> {t('recommendations')}</div>
